...
QUnit.test("Intersection de deux RendezVous avec conflit", function(assert){
    var r1 = new rdv.RendezVous("Ménage", "intervenant1", new Date(2015, 11, 23, 18, 00), 120, "lieu1");
    var r2 = new rdv.RendezVous("Repas", "intervenant2", new Date(2015, 11, 23, 19, 00), 120, "lieu1");

    assert.deepEqual(r1.intersectionMemeLieuOuIntervenant(r2),
        new RendezVous("Ménage, Repas", "intervenant1, intervenant2", new Date(2015, 11, 23, 19, 00), 60, "lieu1"),
        "Renvoit bien l'intersection"
    );
});
